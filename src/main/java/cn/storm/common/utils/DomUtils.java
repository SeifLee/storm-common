...
public class DomUtils {
	 ...
	 * @return 返回文档对象
	 */
	public static Document getXMLByInputStream(InputStream in) {
		if (null == in) {
			return null;
		}
		Document document = null;
	 ...
	 * @return
	 */
	public static String documentToStringNoDeclaredHeader(Document document,
			String charset) {
	...
	public final static Element parseXml(String xml) {
		...
		Element rootElement = document != null ? document.getRootElement()
				: null;
		return rootElement;
	}
